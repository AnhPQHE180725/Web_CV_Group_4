    ...
    public class SeedData
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
                new User { Id = 1, FullName = "John Doe", Email = "john@example.com", Password = "hashedpassword", Address = "123 Main St", PhoneNumber = "1234567890", Status = 1, Description = "Software Developer", CVId = 1,Image="test" },
                new User { Id = 2, FullName = "Jane Smith", Email = "jane@example.com", Password = "hashedpassword", Address = "456 Elm St", PhoneNumber = "9876543210", Status = 1, Description = "Data Analyst", CVId = 2,Image="test" }
            );

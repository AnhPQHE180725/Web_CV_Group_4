...
@Component({
    selector: 'app-favorite-applied-jobs',
    standalone: true,
    imports: [CommonModule, FormsModule],
    templateUrl: './favorite-apply-jobs.component.html',
    styleUrl: './favorite-apply-jobs.component.css'
})
export class FavoriteAppliedJobsComponent implements OnInit {
    appliedJobs: any[] = [];
